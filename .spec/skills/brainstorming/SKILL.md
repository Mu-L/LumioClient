...
5. **Write design doc** — save to `.spec/knowledge/features/<domain>/<topic>.md` and commit
...
- Write the validated design (spec) to `.spec/knowledge/features/<domain>/<topic>.md`
